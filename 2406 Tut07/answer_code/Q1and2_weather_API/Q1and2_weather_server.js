...
IMPORTANT: FOR THIS CODE TO WORK YOU MUST SUPPLY YOUR OWN API
KEY WHERE INDICATED BELOW
...
//const API_KEY = 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX' //<==YOUR API KEY HERE
const API_KEY = '883b246134453e9c4ce142a766529e2d' //<== INSERT YOUR KEY HERE
function sendResponse(weatherData, res){
  //send response to client in the form of a html webpage
  let page = '<html><head><title>API Example</title></head>' +
    '<body>' +
    '<form method="post">' +
...
//Make an HTTP GET request to the openweathermap API
  //options object for http.request() function
  let options = {
  ...
  //actual http request
  //here server is acting as a client of API service
  ...
  }).end()  //important to .end() the request so it will be sent
}
